...
import { registerStudentAction } from "../../Redux/actions/admin";
...
function AddIncome() {
  ...
  const handleFormSubmit = (e) => {
    ...
    dispatch(registerStudentAction(newFormData));
  };
    ...
    <>
      ...
      <div className="w-100 h-screen overflow-y-scroll pb-12 ps-96">
        <div className="flex justify-between py-10 pe-5">
          <h1 className="text-4xl font-bold">Student Registration Page</h1>
          <div>
            <Link
