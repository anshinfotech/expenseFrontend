...
import { addBatchAction } from "../../Redux/actions/admin";
...
const AddBatches = () => {
  ...
  const handleFormSubmit = (e) => {
    e.preventDefault();
    dispatch(addBatchAction(batchData));
  };
      ...
      <div className="w-100 h-screen ps-96 pt-5 pe-5 overflow-scroll">
        ...
        <div className="flex justify-center items-center w-100 mt-20">
          <div className="w-2/3 bg-white flex flex-col items-center py-6">
            ...
            <form className="w-full px-12 flex flex-col" onSubmit={handleFormSubmit}>
  {/* Subject */}
  <select
    className="text-lg border mt-4 px-4 py-2"
    value={batchData.subject}
    onChange={(e) =>
      setBatchData({ ...batchData, subject: e.target.value })
    }
  >
  ...
  <select
    ...
    onChange={(e) =>
      setBatchData({ ...batchData, duration: e.target.value })
    }
  >
  ...
  <select
    className="text-lg border mt-4 px-4 py-2"
    value={batchData.modeofclass}
    onChange={(e) =>
      setBatchData({ ...batchData, modeofclass: e.target.value })
    }
  >
  ...
  <input
    ...
    className="text-lg border mt-4 px-4 py-2"
    value={batchData.mentor}
    onChange={(e) =>
      setBatchData({ ...batchData, mentor: e.target.value })
    }
  />
  ...
  <button
    type="submit"
    className="text-lg mt-4 text-white bg-emerald-600 py-2 font-bold hover:bg-emerald-400"
  >
